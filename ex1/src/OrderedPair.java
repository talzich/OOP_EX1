 ...
 */
public class OrderedPair<K, V> implements Comparable<OrderedPair<node_info, Double>> {
    private K left;
    private V right;
    ...
    @Override
    public int compareTo(OrderedPair<node_info, Double> other) {
    ...
    public boolean equals(OrderedPair<node_info, Double> other) {
